<?php /* Smarty version Smarty-3.0.8, created on 2018-12-23 10:26:57
         compiled from "./assets/themes\internal/items.tpl" */ ?>
<?php /*%%SmartyHeaderCode:3566481135c1f54e1d461b1-91335504%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '0c5d30f722c31985b0e5925504e8642e50c544b7' => 
    array (
  ...
  'nocache_hash' => '3566481135c1f54e1d461b1-91335504',
  'function' => 
  array (
  ),
                ...
                <div class="row mt">
					<div class="col-md-12">
						...
						<section class="panel">
							...
							<div class="col-md-12">
								<form class="form-horizontal" role="form" method="GET" action="items.html?do=search" enctype="multipart/form-data">
									<div class="col-sm-2"><button type="submit" class="btn btn-primary"> بحث </button></div>
									<div class="col-sm-3">
									<select class="form-control" name="status">
										<option value="all" <?php if ($_smarty_tpl->getVariable('status')->value=='all'){?>selected="selected"<?php }?>> الحالة  </option>
										<option value="0" <?php if ($_smarty_tpl->getVariable('status')->value=='0'){?>selected="selected"<?php }?>  >  غير مفعل </option>
										<option value="1"<?php if ($_smarty_tpl->getVariable('status')->value=='1'){?>selected="selected"<?php }?> > مفعل </option>
									</select>
									</div>
									<div class="col-sm-3">
									<select class="form-control" name="category">
										<option value="0"<?php if ($_smarty_tpl->getVariable('category')->value==0){?>selected="selected"<?php }?>> البحث بالقسم </option>
...
" <?php if ($_smarty_tpl->getVariable('_c')->value['id']==$_smarty_tpl->getVariable('category')->value){?>selected="selected"<?php }?>><?php echo $_smarty_tpl->getVariable('_c')->value['name_ar'];?>
</option>
										<?php }} ?>
									</select>
								</div>
									<div class="col-md-3">
										<input type="text" style="text-align: right" name="name" class="form-control " placeholder=" البحث بالاسم " value="<?php echo $_smarty_tpl->getVariable('name')->value;?>
">
									</div>
...
">
									...
									<tbody>
                                        <tr>
								            <td colspan="6" align="center"><b>لا توجد نتائج  </b> </td>
								        </tr>
                                    </tbody>
                                    <?php }?>
									<tfoot>
