<?php /* Smarty version Smarty-3.0.8, created on 2018-12-23 16:23:54
         compiled from "./assets/themes\internal/notifications.tpl" */ ?>
<?php /*%%SmartyHeaderCode:2643701845c1fa88a0b9532-65766779%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'b2a4ef09b0656dd3feeb5c4dd94f471aa3e1ef95' => 
    array (
  ...
  'nocache_hash' => '2643701845c1fa88a0b9532-65766779',
  'function' => 
  array (
  ),
...
?>
											<option value='<?php echo getcategoryposition($_smarty_tpl->getVariable('_c')->value['id']);?>
' <?php ob_start();?><?php echo getcategoryposition($_smarty_tpl->getVariable('_c')->value['id']);?>
...
if ($_smarty_tpl->_count($_from) > 0){
    foreach ($_from as $_smarty_tpl->tpl_vars["_c"]->key => $_smarty_tpl->tpl_vars["_c"]->value){
?>
											<option value=''><?php echo $_smarty_tpl->getVariable('_c')->value['name'];?>
 - <?php echo $_smarty_tpl->getVariable('_c')->value['name_ar'];?>
</option>
										<?php }} ?>
									</select>
